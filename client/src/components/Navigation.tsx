...
export default function Navigation() {
  return (
    <>
      <div className="bg-blue-slate">
        <section
          aria-label=""
          className="container py-2 flex justify-between items-center text-white"
        >
          <div className="flex items-center">
            {["About Me", "Contact Us", "Help"].map(
              (items: string, index: number) => (
                <div
                  key={index}
                  className="border-r-2 border-white px-2 text-xs"
                >
                  {items}
                </div>
              )
          ...
          <div className="flex items-center gap-2">
            <div className="border-r-2 border-white px-2 flex items-center gap-2">
              <span>Follow us:</span>
              <div className="flex gap-3">
                {[
                  ...
                  <svg
                    ...
                    fill="none"
                  >
                    <g clipPath="url(#clip0_2736_3571)">
                      <path
                        fillRule="evenodd"
                        clipRule="evenodd"
                  ...
                  <svg
                    ...
                    fill="none"
                  >
                    <g clipPath="url(#clip0_2736_3574)">
                      <path
                  ...
                  <svg
                    ...
                    fill="none"
                  >
                    <g clipPath="url(#clip0_2736_3576)">
                      <path
                  ...
                  <svg
                    ...
                    fill="none"
                  >
                    <g clipPath="url(#clip0_2736_3582)">
                      <path
        ...
        <section className="container py-2 flex justify-between items-center px-4">
          <div>
            <span className="text-2xl font-black text-white">Logo</span>
          </div>
          <div>
            <div className="w-96 bg-white flex items-center gap-2 px-2">
              <input
                type="text"
                className="w-full bg-transparent caret-gray-700 text-black outline-none focus-visible:outline-none p-2 placeholder:font-semibold font-semibold placeholder:text-violet-300"
